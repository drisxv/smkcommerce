...
<head>
    ...
    <title>Register - SMK Commerce</title>
    @vite('resources/css/app.css')
</head>

<body class="bg-gray-100 h-screen flex items-center justify-center">

    <form method="POST" action="{{ route('register') }}" class="max-w-sm w-full bg-white p-6 rounded-lg shadow-md">
        @csrf

        <h2 class="text-4xl font-bold text-center text-gray-700 py-2 border-b-2">Admin SMK Commerce</h2>
        <h2 class="text-2xl font-bold text-center text-gray-700 my-2">Register</h2>
