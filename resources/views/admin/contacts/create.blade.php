...
@section('content')
    <div class="max-w-3xl mx-auto py-6">
        <h1 class="text-2xl font-bold mb-6">Tambah Contact</h1>
        ...
        <form action="{{ route('admin.contacts.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="address" rows="3"
                    class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300">{{ old('address') }}</textarea>
            </div>
